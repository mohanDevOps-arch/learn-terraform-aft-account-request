...
# ═══════════════════════════════════════════════════════════════
# Bulk CSV #1: sirajMD
# Created: 2025-12-20 02:08:42 UTC
# From: bulk-accounts.csv
# ═══════════════════════════════════════════════════════════════
module "sirajmd_1766196522_1" {
  source = "./modules/aft-account-request"

  control_tower_parameters = {
    AccountEmail              = "mcrajmd@gmail.com"
    AccountName               = "sirajMD"
    ManagedOrganizationalUnit = "Batch15"
    SSOUserEmail              = "ravish.snkhyn@gmail.com"
    SSOUserFirstName          = "Ravish"
  ...
  custom_fields = {
    workflow_run_id = "20387519396"
    batch_timestamp = "1766196522"
    csv_source      = "bulk-accounts.csv"
  }
...
# ═══════════════════════════════════════════════════════════════
# Bulk CSV #1: sirajmd
# Created: 2025-12-20 02:19:06 UTC
# From: bulk-accounts.csv
# ═══════════════════════════════════════════════════════════════
module "sirajmd_1766197146_1" {
  source = "./modules/aft-account-request"

  control_tower_parameters = {
    AccountEmail              = "mcrajmd+hv@gmail.com"
    AccountName               = "sirajmd"
  ...
  custom_fields = {
    workflow_run_id = "20387633434"
    batch_timestamp = "1766197146"
    csv_source      = "bulk-accounts.csv"
  }
...
# ═══════════════════════════════════════════════════════════════
# Bulk CSV #1: HarshaGupta
# Created: 2025-12-20 03:14:10 UTC
# From: bulk-accounts.csv
# ═══════════════════════════════════════════════════════════════
module "harshagupta_1766200450_1" {
  source = "./modules/aft-account-request"

  control_tower_parameters = {
    AccountEmail              = "harshaa.gupta1992+hv@gmail.com"
    AccountName               = "HarshaGupta"
    ManagedOrganizationalUnit = "Batch15"
    SSOUserEmail              = "ravish.snkhyn@gmail.com"
    SSOUserFirstName          = "Ravish"
    SSOUserLastName           = "Sankhyan"
  ...
  custom_fields = {
    workflow_run_id = "20388278922"
    batch_timestamp = "1766200450"
    csv_source      = "bulk-accounts.csv"
  }
...
# ═══════════════════════════════════════════════════════════════
# Bulk CSV #1: inzamam
# Created: 2025-12-20 05:07:57 UTC
# From: bulk-accounts.csv
# ═══════════════════════════════════════════════════════════════
module "inzamam_1766207277_1" {
  source = "./modules/aft-account-request"

  control_tower_parameters = {
    AccountEmail              = "inzamam1061+B15@gmail.com"
    AccountName               = "inzamam"
    ManagedOrganizationalUnit = "Batch14"
    SSOUserEmail              = "ravish.snkhyn@gmail.com"
    SSOUserFirstName          = "Ravish"
  ...
  custom_fields = {
    workflow_run_id = "20389581405"
    batch_timestamp = "1766207277"
    csv_source      = "bulk-accounts.csv"
  }
...
# Created: 2025-12-29 02:53:04 UTC
# From: bulk-accounts.csv
# ═══════════════════════════════════════════════════════════════
module "venkatesha_1766976784_1" {
  source = "./modules/aft-account-request"

  control_tower_parameters = {
    AccountEmail              = "venkat.hm786+hv@gmail.com"
  ...
  custom_fields = {
    workflow_run_id = "20563548932"
    batch_timestamp = "1766976784"
    csv_source      = "bulk-accounts.csv"
  }
